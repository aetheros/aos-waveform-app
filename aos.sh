...
elif  [ -f /usr/local/aos-esr2k-x86_64/environment-setup-armv7a-vfp-neon-oe-linux-gnueabi ]; then
	. /usr/local/aos-esr2k-x86_64/environment-setup-armv7a-vfp-neon-oe-linux-gnueabi
else
